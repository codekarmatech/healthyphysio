  ...
  return (
    <DashboardLayout title="Doctor Dashboard">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {isSampleData && (
          <SampleDataNotice 
            message="Showing sample data. Real data will appear once patients and referrals are added."
          />
        )}
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-gray-500">Manage your patients and referrals efficiently</p>
          </div>
          <Link
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg border-l-4 border-l-green-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
              <Link to="/referrals" className="inline-flex items-center text-sm font-medium text-purple-600 hover:text-purple-700 transition-colors">
                View all referrals
                <svg className="ml-1 w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
                          ...
                          <tbody className="bg-white divide-y divide-gray-200">
                            {recentReferrals.map((referral) => (
                              <tr key={referral.id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                  <div className="text-sm text-gray-900">{referral.therapistName || 'Unassigned'}</div>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
