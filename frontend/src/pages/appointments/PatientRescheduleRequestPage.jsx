...
const PatientRescheduleRequestPage = () => {
  const { id } = useParams();
    ...
    <div className="bg-white shadow overflow-hidden sm:rounded-lg">
      <div className="px-4 py-5 sm:px-6">
        ...
        <p className="mt-1 max-w-2xl text-sm text-gray-500">
          Please provide your preferred date and time for rescheduling.
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            ...
            <div className="sm:col-span-6">
              ...
              <p className="mt-2 text-sm text-gray-500">
                Please provide a reason for your reschedule request. Your request will be reviewed by the administrator.
              </p>
            </div>
          </div>
...
export default PatientRescheduleRequestPage;