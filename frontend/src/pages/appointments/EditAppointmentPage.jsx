...
const EditAppointmentPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(true);
      setTimeout(() => {
        // Navigate to the correct role-based path
        if (user?.role === 'admin') {
  ...
  if (loading) {
    return (
      <DashboardLayout title="Edit Appointment">
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Update the appointment details</p>
          </div>
          <div>
            <Link
        ...
        <div className="px-4 py-5 sm:p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end space-x-3">
              <button
                type="button"
                onClick={() => navigate(user?.role === 'admin' ? '/admin/appointments' : user?.role === 'therapist' ? '/therapist/appointments' : '/appointments')}
