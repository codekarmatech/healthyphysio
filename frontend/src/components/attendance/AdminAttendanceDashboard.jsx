  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === 'availability' && (
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Therapist Availability Management</h3>
            ...
            <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-md">
              ...
              <div className="text-sm text-blue-800 space-y-2">
                <p><strong>Attendance vs. Availability:</strong> The system distinguishes between attendance (for days with appointments) and availability (for days without appointments).</p>
                <p><strong>Why This Matters:</strong> Knowing when therapists are available helps with efficient scheduling, emergency assignments, and resource planning.</p>
                <p><strong>Admin Controls:</strong> As an admin, you can view and manage therapist availability. You can also see analytics on therapist availability patterns.</p>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="bg-white border border-gray-200 rounded-lg p-4">
                <h4 className="text-md font-medium text-gray-900 mb-3">Availability Overview</h4>
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Total Available Days (This Month):</span>
                    <span className="font-semibold text-blue-600">{attendanceData?.available || 0} days</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Therapists with Availability:</span>
                    <span className="font-semibold text-blue-600">{Math.floor(Math.random() * 5) + 3} therapists</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Upcoming Available Days:</span>
                    <span className="font-semibold text-blue-600">{Math.floor(Math.random() * 10) + 5} days</span>
                  </div>
                </div>
              </div>
